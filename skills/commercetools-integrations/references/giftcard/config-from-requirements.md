...
description: Map gift card requirements to a commercetools gift card connector's connect.yaml — the CT connection block, currency, gift-card-system credentials, least-privilege scopes — with a worked example. The gift card sub-area of commercetools-integrations.
metadata:
