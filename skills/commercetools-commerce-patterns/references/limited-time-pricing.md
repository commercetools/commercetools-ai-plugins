...
```json
curl --location 'https://import.us-central1.gcp.commercetools.com/kmb-core-commerce-lab/import-containers' \
...
```json
curl --location 'https://import.us-central1.gcp.commercetools.com/kmb-core-commerce-lab/prices/import-containers/order-import-container-embedded-prices' \
--header 'Content-Type: application/json' \
--header 'Authorization: Bearer' \
--data '{
  "type" : "price",
...

{
    "operationStatus": [
        {
            "operationId": "2c901f1c-9cd8-436a-bec0-034813e7dbc8",
            "state": "processing"
        }
    ]
}
...
```json
curl --location 'https://import.us-central1.gcp.commercetools.com/kmb-core-commerce-lab/import-operations/2c901f1c-9cd8-436a-bec0-034813e7dbc8' \
--header 'Content-Type: application/json' \
--header 'Authorization: Bearer' \
--data ''
```
...
```json
curl --location 'https://import.us-central1.gcp.commercetools.com/kmb-core-commerce-lab/standalone-prices/import-containers/order-import-container-embedded-prices' \
--header 'Content-Type: application/json' \
--header 'Authorization: Bearer' \
--data '{
...

{
    "operationStatus": [
        {
            "operationId": "5fe900ce-8957-4a62-856a-23d659079db3",
            "state": "processing"
        }
    ]
}
...
```json
curl --location 'https://import.us-central1.gcp.commercetools.com/kmb-core-commerce-lab/import-operations/5fe900ce-8957-4a62-856a-23d659079db3' \
--header 'Content-Type: application/json' \
--header 'Authorization: Bearer' \
--data ''
```
