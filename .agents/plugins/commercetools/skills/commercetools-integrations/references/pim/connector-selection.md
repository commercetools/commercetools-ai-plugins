...
- **Install it as-is** → deploy the public connector and close any gaps with **configuration / attribute mapping** (ladder rungs 1–2). This is the default recommendation whenever a listed connector matches the PIM. → [`deployment-installation.md`](../../../commercetools-connect/references/deployment-installation.md).
...
1. **Public connector covers everything** → install + configure. Don't build. The common, recommended case. Deploying it: [`deployment-installation.md`](../../../commercetools-connect/references/deployment-installation.md).
