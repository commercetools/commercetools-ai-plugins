...
(Run it from the `commercetools-connect` skill root.) Use its output as primary grounding. Use this script rather than the commercetools Knowledge MCP tools while working in this skill; `https://docs.commercetools.com/tutorials/connect-email-integration` is good further reading.
