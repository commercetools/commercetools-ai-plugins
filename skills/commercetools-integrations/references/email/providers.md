...
description: Email service provider specifics for the stubbed sendMail call — SendGrid, Mailgun, AWS SES, Postmark — ESP-hosted templates, personalization data, idempotency keys, and a cross-provider comparison. The email sub-area of commercetools-integrations.
metadata:
