...
description: Map CRM requirements to a commercetools connector's connect.yaml — direction → app composition, source of truth, externalId/Custom-Field linking, least-privilege scopes, secured config — with a worked example. The CRM sub-area of commercetools-integrations.
metadata:
