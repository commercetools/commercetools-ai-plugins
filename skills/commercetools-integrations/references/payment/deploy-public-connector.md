...
- Anything about *building, bundling, staging, or certifying* a connector → that's [commercetools-connect](../../../commercetools-connect/SKILL.md), not this path.
