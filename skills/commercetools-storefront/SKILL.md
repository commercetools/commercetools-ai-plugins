...
| Task | Reference |
|------|-----------|
| Scaffold the app, Tailwind v4, next-intl routing, middleware, folder structure | Run `/setup-project` |
...
| Deploy to Netlify | [core/netlify.md](./references/core/netlify.md) |
...
| Order placement from cart and from quote, confirmation | [b2b/checkout.md](./references/b2b/checkout.md) |
...
| Quote lifecycle, multi-round negotiation, commercetools data model, SWR hooks | [b2b/quotes.md](./references/b2b/quotes.md) |
