...
Deploying a public or custom connector (CLI auth, scopes, `deployment create`, regions, certification) is the commercetools-connect skill's [deployment-installation.md](../../../commercetools-connect/references/deployment-installation.md).
...
| Least-privilege scopes, secured config, engine-key handling | [`commercetools-connect` → security.md](../../../commercetools-connect/references/security.md) |
